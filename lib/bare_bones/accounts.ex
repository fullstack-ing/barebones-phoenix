defmodule BareBones.Accounts do
  @moduledoc """
  ...
  alias BareBones.Accounts.{User, UserToken, UserNotifier}
  ...
  See `BareBones.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `BareBones.Accounts.User.password_changeset/3` for a list of supported options.
